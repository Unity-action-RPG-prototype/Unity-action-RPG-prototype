...
public class Detection : MonoBehaviour
{
    ...
    public bool detectioCheck; //if passed, the enemy detects the player
    ...
    {
        visionObstructed = Physics.Raycast(_vision.transform.position, playerDirection, out obstacle, playerDirection.magnitude, Obstacles);
    }
    ...
    public void Update()
    {
        ...
        detectioCheck = stealthDetection > _playerMovement.totalStealth;
    ...
    public void DetectPlayer()
    {
        if (playerIsAlive)
        {
            ...
            else if (playerInNoiseDetectionRange && detectioCheck)//hearing based detection
            {
                if (!reaction)
                {
                    StartCoroutine(Reaction());
