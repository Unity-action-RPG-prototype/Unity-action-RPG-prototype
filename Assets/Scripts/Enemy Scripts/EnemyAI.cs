...
public class EnemyAI : MonoBehaviour
{
    ...
    [SerializeField] Collider _assassinationBox;
    ...
    public STATUS status = STATUS.HOSTILE;
    ...
    void Update()
    {
        ...
        if (!isDead && !deactivateMovement && status == STATUS.HOSTILE)
        {
        ...
        //animations
        if (currentState == STATE.COMBAT || currentState == STATE.SEARCH)
        {
    ...
    public void Die()
    {
        ...
        if (!isDead)
        {
            _assassinationBox.enabled = false;
            isDead = true;
            ...
            if (assassinated)
            {
                _animator.SetTrigger(_animation.assassinated);
            }
            else
            {
